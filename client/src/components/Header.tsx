    ...
    <header className="bg-white shadow-sm">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <Link href="/">
            <span className="text-2xl font-bold text-primary">LottieForge</span>
          </Link>
        ...
        <nav>
          <ul className="flex space-x-6">
            <li>
              <Link href="/projects">
                <span className={`text-gray-700 hover:text-accent transition-colors ${location === "/projects" ? "text-accent" : ""}`}>
                  Projects
                </span>
              </Link>
            </li>
